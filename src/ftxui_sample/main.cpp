...
// configuration step. It creates a namespace called `tinyChat`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", tinyChat::cmake::project_name, tinyChat::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", tinyChat::cmake::project_version);
      return EXIT_SUCCESS;
    }
